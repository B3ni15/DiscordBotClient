...
export const REASONS = {
  ...
  muteMembers: missingPermission("Mute Members"),
  deafenMembers: missingPermission("Deafen Members"),
  moveMembers: missingPermission("Move Members"),
  notInVoice: "This member is not in a voice channel.",
